...
public class FragmentOngKinhNikon extends Fragment {
    String urlStrSPHot = "https://demo5667093.mockable.io/LensTest ";
    ArrayList<MayAnh> mayAnhList;
    View view;
    RecyclerView rvOngKinhNikon;

    public static FragmentOngKinhNikon newInstance() {

        Bundle args = new Bundle();

        FragmentOngKinhNikon fragment = new FragmentOngKinhNikon();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvOngKinhNikon = view.findViewById(R.id.rvOngKinh);

        new OngKinhNikon().execute();

        return view;
    }
    class OngKinhNikon extends AsyncTask<Void,Void,String> {
        String result = "";
        ...
        protected void onPostExecute(String unused) {
            ...
            try {
                ...
                rvOngKinhNikon.setLayoutManager(layoutManager);
                rvOngKinhNikon.setAdapter(mayAnhAdapter);
            }catch (Exception e){
                e.printStackTrace();
            }
        }
