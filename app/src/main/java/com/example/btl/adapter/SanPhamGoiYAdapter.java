...
public class SanPhamGoiYAdapter extends RecyclerView.Adapter<SanPhamGoiYAdapter.ViewHoder> {
    ...
    public  SanPhamGoiYAdapter(List<MayAnh> mayAnhList,Context context){
    ...
    @NonNull
    @Override
    public SanPhamGoiYAdapter.ViewHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SanPhamGoiYAdapter.ViewHoder holder, int position) {
