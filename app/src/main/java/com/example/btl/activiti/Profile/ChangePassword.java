...
import com.example.btl.activiti.LoginActivity;
...
public class ChangePassword extends AppCompatActivity {
    ...
    EditText ePasswordCu, ePasswordMoi, ePasswordMoi2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ePasswordCu = findViewById(R.id.ePasswordCu);
        ePasswordMoi = findViewById(R.id.ePasswordMoi);
        ePasswordMoi2 = findViewById(R.id.ePasswordMoi2);
        ...
        btnXacNhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String matKhauCu = ePasswordCu.getText().toString();
                String matKhauMoi1 = ePasswordMoi.getText().toString();
                String matKhauMoi2 = ePasswordMoi2.getText().toString();
