...
public class FragmentMayAnhNikon extends Fragment {
    String urlStrSPHot = "https://demo5667093.mockable.io/SanPhamHot";
    ArrayList<MayAnh> mayAnhList;
    View view;
    RecyclerView rvMayAnhNikon;

    public static FragmentMayAnhNikon newInstance() {

        Bundle args = new Bundle();

        FragmentMayAnhNikon fragment = new FragmentMayAnhNikon();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvMayAnhNikon = view.findViewById(R.id.rvMayAnh);

        new MayAnhNikon().execute();

        return view;
    }
    class MayAnhNikon extends AsyncTask<Void,Void,String> {
        String result = "";
        ...
        protected void onPostExecute(String unused) {
            ...
            try {
                ...
                rvMayAnhNikon.setLayoutManager(layoutManager);
                rvMayAnhNikon.setAdapter(mayAnhAdapter);
            }catch (Exception e){
                e.printStackTrace();
            }
        }
