package com.example.btl.FragmentMayAnh;
...
public class FragmentMayAnhCanon extends Fragment {
    String urlStrSPHot = "https://demo5667093.mockable.io/SanPhamHot";
    ArrayList<MayAnh> mayAnhList;
    View view;
    RecyclerView rvMayAnhCanon;

    public static FragmentMayAnhCanon newInstance() {

        Bundle args = new Bundle();

        FragmentMayAnhCanon fragment = new FragmentMayAnhCanon();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.mayanh_fragment,container,false);
        rvMayAnhCanon = view.findViewById(R.id.rvMayAnh);

        new MayAnhCanon().execute();

        return view;
    }
    class MayAnhCanon extends AsyncTask<Void,Void,String> {
        String result = "";
        ...
        protected void onPostExecute(String unused) {
            ...
            try {
                ...
                rvMayAnhCanon.setLayoutManager(layoutManager);
                rvMayAnhCanon.setAdapter(mayAnhAdapter);
            }catch (Exception e){
                e.printStackTrace();
            }
        }
