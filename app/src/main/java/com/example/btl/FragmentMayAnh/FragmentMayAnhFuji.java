...
public class FragmentMayAnhFuji extends Fragment {
    String urlStrSPHot = "https://demo5667093.mockable.io/SanPhamHot";
    ArrayList<MayAnh> mayAnhList;
    View view;
    RecyclerView rvMayAnhFuji;

    public static FragmentMayAnhFuji newInstance() {

        Bundle args = new Bundle();

        FragmentMayAnhFuji fragment = new FragmentMayAnhFuji();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvMayAnhFuji = view.findViewById(R.id.rvMayAnh);

        new MayAnhFuji().execute();

        return view;
    }
    class MayAnhFuji extends AsyncTask<Void,Void,String> {
        String result = "";
        ...
        protected void onPostExecute(String unused) {
            ...
            try {
                ...
                rvMayAnhFuji.setLayoutManager(layoutManager);
                rvMayAnhFuji.setAdapter(mayAnhAdapter);
            }catch (Exception e){
                e.printStackTrace();
            }
        }
