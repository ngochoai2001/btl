...
public class FragmentMayAnhSony extends Fragment {
    String urlStrSPHot = "https://demo5667093.mockable.io/SanPhamHot";
    ArrayList<MayAnh> mayAnhList;
    View view;
    RecyclerView rvMayAnhSony;

    public static FragmentMayAnhSony newInstance() {

        Bundle args = new Bundle();

        FragmentMayAnhSony fragment = new FragmentMayAnhSony();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvMayAnhSony = view.findViewById(R.id.rvMayAnh);

        new MayAnhSony().execute();

        return view;
    }
    class MayAnhSony extends AsyncTask<Void,Void,String> {
        String result = "";
        ...
        protected void onPostExecute(String unused) {
            ...
            try {
                ...
                rvMayAnhSony.setLayoutManager(layoutManager);
                rvMayAnhSony.setAdapter(mayAnhAdapter);
            }catch (Exception e){
                e.printStackTrace();
            }
        }
