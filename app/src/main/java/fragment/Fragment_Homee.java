...
import activiti.LoaiSanPham.SanPhamHot;
import activiti.LoaiSanPham.SanPhamMoiNhat;
...
public class Fragment_Homee extends Fragment implements ValueEventListener {
    ...
    public static Fragment_Homee newInstance() {

        Bundle args = new Bundle();

        Fragment_Homee fragment = new Fragment_Homee();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        int soLuongHang = MainActivity.gioHangArrayList.size();
        if(soLuongHang < 1){
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(getContext(), Cart.class);
        ...
        btnMayAnh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(getContext(), activiti.MayAnh.class);
        ...
        btnLens.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), activiti.OngKinh.class);
    ...
    class DataGetProductSPMoi extends AsyncTask<Void,Void,String> {
        ...
        protected void onPostExecute(String unused) {
            ...
            try {
                ...
                SanPhamAdapter sanPhamMoiAdapter = new SanPhamAdapter(mayAnhList,getContext());
